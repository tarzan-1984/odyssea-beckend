...
describe('StorageController', () => {
  ...
  describe('presign', () => {
    it('should create presigned URL successfully', async () => {
      ...
      expect(s3Service.createPresignedPut).toHaveBeenCalledWith('test.pdf', 'application/pdf');
    });
    ...
    it('should create presigned URL with minimal data', async () => {
      ...
      expect(result).toEqual(mockResult);
      expect(s3Service.createPresignedPut).toHaveBeenCalledWith(undefined, undefined);
    });
