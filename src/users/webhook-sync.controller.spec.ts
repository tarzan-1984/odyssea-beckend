...
describe('SyncController - Webhook', () => {
	...
	describe('processWebhook', () => {
		...
		it('should process driver update webhook successfully', async () => {
			const webhookData: WebhookSyncDto = {
      ...
      role: UserRole.DISPATCHER,
		...
		it('should process employee update webhook successfully', async () => {
			const webhookData: WebhookSyncDto = {
				type: WebhookType.UPDATE,
				role: WebhookRole.EMPLOYEE,
				timestamp: '2025-09-12 04:13:00',
				source: 'tms-statistics',
				user_data: {
					id: 29,
					user_email: 'milchenko2k16+555455@gmail.com',
					display_name: 'Serhii Milchenko',
					first_name: 'Serhiis',
					last_name: 'Milchenkos',
					roles: ['dispatcher'],
					user_registered: '2025-09-11 14:20:14',
					acf_fields: {
						permission_view: ['Odysseia', 'Martlet', 'Endurance'],
						initials_color: '#0d6efd',
						work_location: 'pl',
						phone_number: '(667) 290-8888',
						flt: false,
					},
				},
			};
			...
			const expectedResult = {
				...
				user: {
					id: '1',
					externalId: '29',
					email: 'milchenko2k16+555455@gmail.com',
					firstName: 'Serhiis',
					lastName: 'Milchenkos',
					phone: '(667) 290-8888',
					location: 'pl',
      ...
      role: UserRole.DISPATCHER,
		...
		it('should process employee delete webhook successfully', async () => {
			const webhookData: WebhookSyncDto = {
				type: WebhookType.DELETE,
				role: WebhookRole.EMPLOYEE,
