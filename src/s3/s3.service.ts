...
export class S3Service {
  ...
  private endpoint = process.env.WASABI_ENDPOINT || 'https://s3.eu-central-1.wasabisys.com';
  ...
  async createPresignedPut(filename?: string, contentType?: string) {
    ...
    try {
      ...
      throw new BadRequestException(`Failed to create presigned URL: ${error.message}`);
    }
  }
}